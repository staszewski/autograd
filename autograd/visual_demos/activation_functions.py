...
class LearningDynamicsScene(Scene):
    def construct(self):
        ...
        comparison = VGroup(
            Text("• ReLU: Fast convergence, no saturation in positive region", font_size=14, color=GREEN),
            Text("• Sigmoid: Slow convergence, vanishes at extremes", font_size=14, color=YELLOW),
            Text("• Tanh: Zero-centered, faster than Sigmoid, still vanishes", font_size=14, color=PURPLE)
